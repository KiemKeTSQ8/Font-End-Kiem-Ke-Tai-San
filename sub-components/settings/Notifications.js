                    ...
                    <Card.Body>
                        ...
                        <Table responsive className="mb-0 text-nowrap">
                            ...
                            <tr>
                                ...
                                <th>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         ...
                                         strokeLinejoin="round" className="feather feather-smartphone icon-sm me-2">
                                        <rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect>
                                        <line x1="12" y1="18" x2="12.01" y2="18"></line>
                                    </svg>
                                </th>
                                <th>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                         strokeLinejoin="round" className="feather feather-slack icon-sm me-2">
                                        <path
                                            d="M14.5 10c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z"></path>
                                        <path
                                            d="M20.5 10H19V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"></path>
                                ...
                                <th>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                         strokeLinejoin="round" className="feather feather-mail icon-sm me-2">
                                        <path
                                            d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                                        <polyline points="22,6 12,13 2,6"></polyline>
                                    </svg>
                            ...
                            <tr>
                                ...
                                <td className="border-top-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                         strokeLinejoin="round" className="feather feather-minus text-muted icon-sm">
                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                    </svg>
                                </td>
                                <td className="border-top-0">
                        ...
                        <Row>
                            <Col xl={6} md={12} className="mb-3">
                                ...
                                <Form.Control as={FormSelect} defaultselected="Always" id="notification"
                                              options={notificationOptions}/>
                            </Col>
                            <Col xl={3} md={6} className="mb-3">
                                <Form.Label htmlFor="dailyDigest">Daily Digest</Form.Label>
                                <Form.Control as={FormSelect} defaultselected="Everyday" id="dailyDigest"
