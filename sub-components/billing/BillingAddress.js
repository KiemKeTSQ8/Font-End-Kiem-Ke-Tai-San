                            ...
                            <Col lg={6} md={12} xs={12} className="mb-4 mb-lg-0">
                                <div className="mb-3 mb-lg-0">
                                    <Form.Check id="shippingBillingAddress1">
                                        ...
                                        <Form.Check.Label>
                                            <span
                                                className="d-block mb-3 text-dark fw-bold">Shipping Billing Address</span>
                                            <span className="d-block text-dark fw-medium fs-4">Valarie Tarrant</span>
                                            <span
                                                className="d-block mb-4">3757 Morgan Street Tallahassee, FL 32301</span>
                                            <Link href="#" className="me-2 link-success">Edit</Link>
                                            <Link href="#" className="me-2 link-danger">Delete</Link>
                                            <Link href="#" className="me-2 text-muted text-primary-hover">Remove as
                                                Default Billing</Link>
                                        </Form.Check.Label>
                                    </Form.Check>
                                </div>
                            </Col>
                            ...
                            <Col lg={6} md={12} xs={12} className="mb-4 mb-lg-0">
                                <Form.Check id="shippingBillingAddress2">
                                    ...
                                    <Form.Check.Label>
                                        ...
                                        <Link href="#" className="me-2 link-success">Edit</Link>
                                        <Link href="#" className="me-2 link-danger">Delete</Link>
                                        <Link href="#" className="me-2 text-muted text-primary-hover">Set as
                                            Default</Link>
                                    </Form.Check.Label>
                                </Form.Check>
                            </Col>
